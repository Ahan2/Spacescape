...
public class AmandaScript1 : MonoBehaviour {
	...
	void Start(){
		...
		target = GameObject.FindGameObjectWithTag("plane4").transform;
		targetOriginal = GameObject.FindGameObjectWithTag("plane3").transform;
		flag = false;
	}
	void Update () {
