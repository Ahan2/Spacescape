...
public class AmandaScript3 : MonoBehaviour {
	...
	void Start(){
		...
		target = GameObject.FindGameObjectWithTag("plane5").transform;
		targetOriginal = GameObject.FindGameObjectWithTag("plane6").transform;
		flag = false;
	}
	void Update () {
