...
public class AmandaScript9 : MonoBehaviour {
	...
	void Start(){
		...
		target = GameObject.FindGameObjectWithTag("plane17").transform;
		targetOriginal = GameObject.FindGameObjectWithTag("plane18").transform;
		flag = false;
	}
	void Update () {
