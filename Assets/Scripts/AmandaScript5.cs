...
public class AmandaScript5 : MonoBehaviour {
	...
	void Start(){
		...
		target = GameObject.FindGameObjectWithTag("plane9").transform;
		targetOriginal = GameObject.FindGameObjectWithTag("plane10").transform;
		flag = false;
	}
	void Update () {
